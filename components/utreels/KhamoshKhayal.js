...
export default class KhamoshKhayal extends Component {
    constructor(props) {        
        super(props);
        this.state = {
          isLoading: true,            
    ...
    componentDidMount() { 
      fetch('https://www.ujjawaltrivedi.com/api/pages/khamoshkhayal.php',{
        method: 'POST',
        headers: {
  ...
  render() {
    ...
    return (
        ...
        <Icon name="angle-left" size={30} color="#000000" />
          ...
          <Body>
          <Title style={styles.title}>Khamosh Khayal</Title>
          </Body>
        </Header>
