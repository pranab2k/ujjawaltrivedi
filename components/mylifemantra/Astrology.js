...
export default class Astrology extends Component {
  constructor(props) {
    ...
    componentDidMount() { 
      fetch('https://www.ujjawaltrivedi.com/api/pages/homepage.php?cID=UCitVZ7elVbWd4O43stZQxgA',{
        method: 'POST',
        headers: {
    ...
    Getvideo(vid,title){
     ...
     loadMoreData = () =>  { 
      ...
      //  alert(this.state.NextPage);
        ...
        fetch('https://www.ujjawaltrivedi.com/api/pages/homepage.php?cID=UCitVZ7elVbWd4O43stZQxgA&pageToken='+this.state.NextPage,{
          method: 'POST',
          headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
  ...
  render() {
    ...
    return (
        ...
        <Icon name="angle-left" size={30} color="#000000" />
          ...
          <Body>
          <Title style={styles.title}>Astrology</Title>
          </Body>
        </Header>
