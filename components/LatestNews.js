  ...
  render() {
    ...
    return (
      <Content style={{flex:1}}>
        <View>   
        <TouchableOpacity style={{paddingLeft:10,paddingTop:10}} onPress={ ()=>{ Linking.openURL('https://DellTechnologies.com/HereToHelp')}}>
...
<TouchableOpacity style={{marginLeft:10}} onPress={ ()=>{ Linking.openURL('https://varindia.com/ad/2019/aws/micro/index.php')}}>
