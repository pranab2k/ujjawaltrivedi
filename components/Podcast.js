...
export default class Podcast extends Component {
    ...
    componentDidMount() { 
      fetch('https://www.ujjawaltrivedi.com/api/pages/podcast.php',{
        method: 'POST',
        headers: {
    ...
    GetPosts(postid){
      ...
      //alert('ok');
      // Alert.alert(postid);
        this.props.navigation.navigate('S13',{postId:postid});
       }
...
<FlatList       
    ...
    renderItem={({item}) => 
    <TouchableOpacity style={styles.textView} onPress={this.GetPosts.bind(this,item.id)}>     
    <View>
         <View>          
