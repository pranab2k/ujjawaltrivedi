...
export default class Entertainment extends Component {
    constructor(props) {        
      ...
      componentDidMount() { 
        ...
        fetch('https://www.ujjawaltrivedi.com/api/pages/posts.php',{
          method: 'POST',
          headers: {
      ...
      // console.log(responseJson.items);
       this.setState({ 
            isLoading: false,     
            postId:responseJson.Entertainment.id,
            postTitle:responseJson.Entertainment.title.rendered,
            postContent:responseJson.Entertainment.content.rendered,
            postImage:responseJson.Entertainment.featured_media_src_url,
      }); 
  ...
  render() {
    ...
    const imageratio = (win.width)/620; //1024 is actual image width
    const Fimagewidth = win.width-20;
 ...
 <Image source = {{ uri: this.state.postImage}} style={{width:Fimagewidth, height: Fimageheight}} /> 


 <HTML source={{html: this.state.postContent}}/>   
    </View>
